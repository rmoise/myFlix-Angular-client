...
export class MovieCardComponent implements OnInit {
  ...
  /**
   * Opens OverviewComponent as a dialog
   * @param title - title of the movie
   * @param description - description of the movie
   */
  openOverviewDialog(title: string, description: string): void {
  ...
  onToggleFavMovie(id: string): void {
    ...
    if (!this.favoriteMovies.includes(id)) {
      this.fetchApiDataService.addFavoriteMovie(id).subscribe(
        (res) => {
          this.favoriteMovies = res.FavoriteMovies;
      ...
      this.fetchApiDataService.deleteFavoriteMovie(id).subscribe(
        (res) => {
          this.favoriteMovies = res.FavoriteMovies;
